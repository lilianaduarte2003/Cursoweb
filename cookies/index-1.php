...
setcookie('font-size', '30px', time() + 3, '/');
...
setcookie('color', 'yellow', time() + 3, '/'); //Crea cookie de nombre color, valor yellow
setcookie('cbackground-color', 'orange', time() + 3, '/'); //Crea cookie de nombre color, valor yellow
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body>
	...
	<a href="texto1.php">Ir a la página texto.php</a>
</body>
</html>